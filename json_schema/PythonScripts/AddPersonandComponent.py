...
def main():
    ...
    with conn:
        ...
        # component
        component1 = ('hok-staff-active', 'Steve Smith',"1", entity_guid, 'Person', 'person.details', 'http...', 'json', 'HOK' ,0 ,'looking good', 1, '20220403' , 'HOK People APP' ,'jdjdjdjdjd' ,'person.details.v01', 'some json')
